<template>
  <div class="community_posts tile gray-tile">
    <div v-if="isCommunityMember || isCommunityAdmin" class="tiled description inner-tile">
      <form>
    ...
    <ul v-if="isCommunityMember || isCommunityAdmin" class="list-group clearfix">
    ...
    <h6 v-else class="title">Please join the community in order to see posts inside this community</h6>
  </div>
</template>
